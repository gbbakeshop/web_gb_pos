      ...
      <div className="sm:flex sm:items-center sm:justify-between">
        <div>
          <div className="flex items-center gap-x-3">
            <h2 className="text-lg font-medium text-gray-800 dark:text-white">List of Loyal Card</h2>

            <span className="px-3 py-1 text-xs text-blue-600 bg-blue-100 rounded-full dark:bg-gray-800 dark:text-blue-400">{loyal_cards.length} Loyal Card</span>
          </div>
            ...
            <div className="overflow-hidden border border-gray-200 dark:border-gray-700 md:rounded-lg">
              <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                <thead className="bg-gray-50 dark:bg-gray-800">
                  <tr>
                    <th scope="col" className="py-3.5 px-12 text-sm font-normal text-left rtl:text-right text-gray-500 dark:text-gray-400">
                        ...
                        <tr key={i}>
                          <td className="px-12 py-4 text-sm font-medium whitespace-nowrap">
                            <a href={'/barcode?value='+res.barcode} target='_blank'>
                              <h2 className="font-medium text-gray-800 dark:text-white underline">{res.fullname}</h2>
                            </a>
                          </td>
                          ...
                          <h2 className="font-medium text-gray-800 dark:text-white ">{res.pincode}</h2>
                          </td>
                          <td className="px-4 py-4 text-sm whitespace-nowrap">
                          <h2 className="font-medium text-gray-800 dark:text-white ">{res.discount}</h2>
                          </td>
                          <td className="px-4 py-4 text-sm whitespace-nowrap">
                          <h2 className="font-medium text-gray-800 dark:text-white ">{moment(res.created_at).format('LLL')}</h2>
                          </td>
