      ...
      <div className="sm:flex sm:items-center sm:justify-between">
        <div>
          <div className="flex items-center gap-x-3">
            <h2 className="text-lg font-medium text-gray-800 dark:text-white">List of Recipes</h2>
                    ...
                    products.map((res, i) => {
                      return (
                        <tr key={i}>
                          ...
                          <h2 className="font-medium text-gray-800 dark:text-white ">{res.quantity}</h2>
                          </td>
                          <td className="px-4 py-4 text-sm whitespace-nowrap">
