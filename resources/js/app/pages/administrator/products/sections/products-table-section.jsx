...
<<<<<<< HEAD
            <h2 className="text-lg font-medium text-gray-800  text-white">List of Products</h2>

            <span className="px-3 py-1 text-xs text-blue-600 bg-blue-100 rounded-full  bg-gray-800  text-blue-400">{products.length} products</span>
=======
            <h2 className="text-lg font-medium text-gray-800  ">List of Products</h2>

            <span className="px-3 py-1 text-xs text-blue-600 bg-blue-100 rounded-full ">{products.length} products</span>
>>>>>>> 5aa5cf6b8e1c9cea954c32c866f3e1b5024f23a9
          </div>
...
<<<<<<< HEAD
          <button className="flex items-center justify-center w-1/2 px-5 py-2 text-sm text-gray-700 transition-colors duration-200 bg-white border rounded-lg gap-x-2 sm:w-auto  hover:bg-gray-800  bg-gray-900 hover:bg-gray-100  text-gray-200  border-gray-700">
=======
          <button className="flex items-center justify-center w-1/2 px-5 py-2 text-sm text-gray-700 transition-colors duration-200 bg-white border rounded-lg gap-x-2 sm:w-auto border-gray-700">
>>>>>>> 5aa5cf6b8e1c9cea954c32c866f3e1b5024f23a9
...
<<<<<<< HEAD
        <div className="inline-flex overflow-hidden bg-white border divide-x rounded-lg  bg-gray-900 rtl:flex-row-reverse  border-gray-700  divide-gray-700">
          <button className="px-5 py-2 text-xs font-medium text-gray-600 transition-colors duration-200 bg-gray-100 sm:text-sm  bg-gray-800  text-gray-300">
            View all
          </button>
          ...
          {/* <button className="px-5 py-2 text-xs font-medium text-gray-600 transition-colors duration-200 sm:text-sm  hover:bg-gray-800  text-gray-300 hover:bg-gray-100">
=======
        <div className="inline-flex overflow-hidden bg-white border divide-x rounded-lg  rtl:flex-row-reverse  border-gray-700  divide-gray-700">
...
<<<<<<< HEAD
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-5 h-5 mx-3 text-gray-400  text-gray-600">
=======
            ...
            <div className="overflow-hidden border border-gray-200  border-gray-700 md:rounded-lg">
              <table className="min-w-full divide-y divide-gray-200  divide-gray-700">
                <thead className="bg-gray-50  bg-gray-800">
                  <tr>
                    <th scope="col" className="py-3.5 px-12 text-sm font-normal text-left rtl:text-right text-gray-500  text-gray-400">
=======
...
<<<<<<< HEAD
                              <h2 className="font-medium text-gray-800  text-white underline">{res.barcode}</h2>
                            </a>
                          </td>
                          <td className="px-4 py-4 text-sm font-medium whitespace-nowrap">
                          <h2 className="font-medium text-gray-800  text-white ">{res.description}</h2>
                          </td>
                          <td className="px-4 py-4 text-sm whitespace-nowrap">
                          <h2 className="font-medium text-gray-800  text-white ">{res.quantity}</h2>
                          </td>
                          <td className="px-4 py-4 text-sm whitespace-nowrap">
                          <h2 className="font-medium text-gray-800  text-white ">{res.price}</h2>
=======
                              <h2 className="font-medium text-gray-800 underline">{res.barcode}</h2>
                            </a>
                          </td>
                          <td className="px-4 py-4 text-sm font-medium whitespace-nowrap">
                          <h2 className="font-medium text-gray-800 ">{res.description}</h2>
                          </td>
                          <td className="px-4 py-4 text-sm whitespace-nowrap">
                          <h2 className="font-medium text-gray-800 ">{res.quantity}</h2>
                          </td>
                          <td className="px-4 py-4 text-sm whitespace-nowrap">
                          <h2 className="font-medium text-gray-800 ">{res.price}</h2>
>>>>>>> 5aa5cf6b8e1c9cea954c32c866f3e1b5024f23a9
                          </td>
