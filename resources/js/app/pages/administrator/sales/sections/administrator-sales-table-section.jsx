                ...
                <div className="sm:flex sm:items-center sm:justify-between">
                    <div>
                        <div className="flex items-center gap-x-3">
                            <h2 className="text-lg font-medium text-gray-800 dark:text-white">List of Sales</h2>
                                            ...
                                            sales.map((res, i) => {
                                                return <tr key={i}>
                                                    ...
                                                    <td className="px-2 py-2 text-sm font-medium whitespace-nowrap">
                                                        <h2 className="font-medium text-gray-800 dark:text-white ">{res.subtotal}</h2>
                                                    </td>
                                                    ...
                                                    <td className="px-2 py-2 text-sm whitespace-nowrap">
                                                        ...
                                                        <h2 className="font-medium text-gray-800 dark:text-white ">{res.tax}</h2>
                                                    </td>

                                                    <td className="px-2 py-2 text-sm whitespace-nowrap">

                                                        <h2 className="font-medium text-gray-800 dark:text-white ">{res.change}</h2>
                                                    </td>

                                                    <td className="px-2 py-2 text-sm whitespace-nowrap">

                                                        <h2 className="font-medium text-gray-800 dark:text-white ">{res.tenders}</h2>
                                                    </td>
                                                    <td className="px-2 py-2 text-sm whitespace-nowrap">
