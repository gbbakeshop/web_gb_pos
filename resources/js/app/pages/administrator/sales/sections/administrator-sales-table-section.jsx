        ...
        <div>
            <section className="container px-2 my-4 mx-auto">
                <div className="sm:flex sm:items-center sm:justify-between">
                    <div>
                        <div className="flex items-center gap-x-3">
                            ...
                            <span className="px-3 py-1 text-xs text-blue-600 rounded-full  bg-blue-200">240 vendors</span>
                        </div>
                    ...
                    <div className="flex items-center mt-4 gap-x-3">
                        {/* <button className="flex items-center justify-center w-1/2 px-5 py-2 text-sm transition-colors duration-200 border rounded-lg gap-x-2 sm:w-auto   bg-gray-900 hover:bg-gray-100  text-gray-200  ">
                ...
                <div className="mt-6 md:flex md:items-center md:justify-between">
                    {/* <div className="inline-flex overflow-hidden bg-white border divide-x rounded-lg  bg-gray-900 rtl:flex-row-reverse    ">
                    ...
                    <form
                        ...
                        <input type="text"
                            ...
                            placeholder="Search" className="block w-full py-1.5 pr-5 text-gray-700  rounded-lg md:w-80 placeholder-gray-400/70 pl-11 rtl:pr-11 rtl:pl-5 border   border-gray-600 focus:border-blue-400   focus:ring-blue-300 focus:outline-none focus:ring focus:ring-opacity-40" />
                        <button
                            type='submit'
                        ...
                        <div className="inline-block min-w-full py-2 align-middle md:px-6 lg:px-8">
                            ...
                            <div className="mt-6 sm:flex sm:items-center sm:justify-between ">
                                ...
                                <div className="flex items-center mt-4 gap-x-4 sm:mt-0">
                                    <button
                                        onClick={backPage}
                                        className="flex items-center justify-center w-1/2 px-5 py-2 text-sm text-gray-700 capitalize transition-colors duration-200 bg-white border rounded-md sm:w-auto gap-x-2 hover:bg-gray-100  bg-gray-900  text-gray-200    hover:bg-gray-800">
