                ...
                <div className="flex w-full items-center justify-center">
                    <div className="w-80 px-6 pt-8 ">
                        ...
                        <div className="flex flex-col justify-center items-center gap-2">
                            <h4 className="font-semibold">GBS Store</h4>
